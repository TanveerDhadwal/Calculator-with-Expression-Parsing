...
OBJS          = driver$(OBJEXT) Calculator$(OBJEXT) Eval_Expr_Tree$(OBJEXT) Expr_Tree_Builder$(OBJEXT) Expr_Tree$(OBJEXT) Expr_Node$(OBJEXT) Binary_Expr_Node$(OBJEXT) Add_Expr_Node$(OBJEXT) Subtract_Expr_Node$(OBJEXT) Multiply_Expr_Node$(OBJEXT) Divide_Expr_Node$(OBJEXT) Mod_Expr_Node$(OBJEXT) Num_Expr_Node$(OBJEXT)
SRC           = driver.cpp Calculator.cpp Eval_Expr_Tree.cpp Expr_Tree_Builder.cpp Expr_Tree.cpp Expr_Node.cpp Binary_Expr_Node.cpp Add_Expr_Node.cpp Subtract_Expr_Node.cpp Multiply_Expr_Node.cpp Divide_Expr_Node.cpp Mod_Expr_Node.cpp Num_Expr_Node.cpp
LINK.cc       = $(LD) $(LDFLAGS)
EXPORTFLAGS   = 
